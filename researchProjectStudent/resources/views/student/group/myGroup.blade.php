        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <div class="page-header row no-gutters py-4" style="margin-left: 10px">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">My Group</h3>
              </div>
            </div>
              ...
              <div class="col">
                <div class="card card-small mb-4">
                  ...
                  <div class="card-body p-0 pb-3 text-center">
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <!--  <th scope="col" class="border-0">Topic ID</th>
                    ...
                    <tr>
                      <td><%=user[i].group_id%></td>
                      <td><%=user[i].student_id%></td>
                      <td><%=user[i].student_fname%>&nbsp;<%=user[i].student_lname%></td>
                      <td><%=user[i].student_email%></td>
                      <td><%=user[i].student_contact%></td>
                      <td><%=user[i].student_dept%></td>
                   </tr>
                   <%}%>
                   <!--   <tr>
                     <td colspan="5"></td>
                     <td><button class="btn btn-accent" value="<%=user.group_id%>" onclick="addMember(this.value)">Add Member</button></td>
                                      </tr -->
